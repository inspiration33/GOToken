...
module.exports = function(deployer, network, accounts) {
    let lockedLiquidityWallet = accounts[9];
    let unlockedLiquidityWallet = accounts[8];
    let wallet = accounts[7];

    if ( network == "ropsten") {
        lockedLiquidityWallet = '0x7eA91A18B73569103fc8391356E03C03AEdDd215';
    ...
    console.log('[ lockedLiquidityWallet.address ]: ' + lockedLiquidityWallet);
